...
//    // doPost method is invoked. 
    ...
    protected void doPost( HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException { 
		...
		try{
			...
			String query = "UPDATE administrator SET email=?, password=?, name=?, dob=?, phone=?, address=? WHERE email='"+email+"' and password='"+password+"'"; 
			...
			response.sendRedirect("UserManagemnt/Administrator/home-administrator.jsp");

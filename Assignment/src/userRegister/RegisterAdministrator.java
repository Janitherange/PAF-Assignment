...
@WebServlet("/registerAdministrator")
public class RegisterAdministrator extends HttpServlet {
	...
	UserConnection administratorConnection = new UserConnection();
...
//    // doPost method is invoked. 
    ...
    protected void doPost( HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException { 
		...
		try{
			...
			Connection connect = administratorConnection.getConnection();
			...
			String query = " insert into administrator (`adminID`,`email`,`password`,`name`,`dob`,`phone`,`address`)"
					+ " values (?, ?, ?, ?, ?, ?, ?)";
			...
			response.sendRedirect("./UserManagemnt/Administrator/administrator-list.jsp");

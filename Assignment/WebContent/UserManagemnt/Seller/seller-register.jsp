    		...
    		<div class="card card0 border-0">
        		<div class="row d-flex">
        			<div class="col-lg-3">
                		...
                		<div class="row px-3"> 
                			<label class="mb-2">
                            	<h1 class="mb-0 ">Seller Registration</h6>
                        	</label>
                        </div>
                        <div class="card1 pb-5">
            		...
            		<div class="col-lg-9">
                		<div class="card2 card border-0 px-4 ">
                			<form class="row g-3 needs-validation" action="<%= request.getContextPath() %>/registerSeller" method="post" novalidate>
                				<div class="col-md-6">
                					<div class="row px-3"> 
                						<label class="mb-1 ">
                    			...
                    			<div class="row mb-4 px-3"> <small class="font-weight-bold">Already have an account? <a class="text-danger " href ='/gadgetBadget/UserManagemnt/Seller/seller-sign-in.jsp'>Login</a></small> </div>

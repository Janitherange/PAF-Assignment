            	...
            	<div class="col-lg-6">
                	<div class="card2 card border-0 px-4 py-5">
                		<div class="row mb-4 px-3">
                			<h1 class=" mr-4 mt-2 left" style="margin-left: -24px;">Sign In Seller</h1>
                		</div>
                		<div class="row mb-4 px-3">
                		...
                		<form  class="row g-3 needs-validation" action="<%= request.getContextPath() %>/loginSeller" method="post" novalidate>
                    		<div class="row px-3"> 
	                    		<label class="mb-1">

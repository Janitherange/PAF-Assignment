                		...
                		<div class="row mb-4 px-3">
                			<h1 class="mb-5 mr-4 mt-2 left" style="margin-left: -24px;">Customer Management</h1>
								<div class="row mb-3 px-3"> 
                    				<button type="button" class="btn btn-blue text-center" onClick="location.href ='/gadgetBadget/UserManagemnt/userCrud/customer-add.jsp'">Add Customer</button> 
                    			</div>
<%
								//Delete item----------------------------------
								if (request.getParameter("customerID") != null)
								{
									...
									Obj2.deleteCustomer(request.getParameter("customerID"));
								}
%>
<%                 				UserDAO Obj1 = new UserDAO();
 								out.print(Obj1.readCustomers());
%>

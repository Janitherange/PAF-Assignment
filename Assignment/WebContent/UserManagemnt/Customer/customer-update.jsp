            	...
            	<div class="col-lg-10">
                	<div class="card2 card border-0 px-4 py-5">
                		<div class="row mb-4 px-3">
                			<h1 class="mb-5 mr-4 mt-2 left" style="margin-left: -24px;">Update Profile</h1>
                				<div class="row mb-3 px-3"> 
                    				<button type="button" class="btn btn-blue text-center" onClick="location.href ='/gadgetBadget/UserManagemnt/customer/home-customer.jsp'">
                    					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
  											<path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z"/>
										</svg> Back								
									</button> 
                    			</div>
								<form class="row g-3 needs-validation" action="<%= request.getContextPath() %>/updateCustomer" method="post" novalidate >
								<%
								...
								%>
									<div class="col-md-6">
                							...
                							<input type="hidden" id="productID" name="customerID" value='<%=resultSet.getString("customerID") %>'>
                        			...
                        			<div class="col-md-12">
                        				<div class="row px-3"> 
                							...
                							<input class="mb-4 px-3 form-control" type="text" id="description" name="address" placeholder="Enter a address" value='<%=resultSet.getString("address") %>' required> 
                							<div class="valid-feedback message">Valid</div>
                							<div class="invalid-feedback message">Name shouldn't be empty</div>
                        				</div>
                        			</div>
                        			<div class="col-md-6">
                        				<div class="row px-3"> 
                							...
                							<input class="mb-4 px-3 form-control" type="password" id="description" name="password" placeholder="Enter a password" value='<%=resultSet.getString("password") %>' required> 
                							<div class="valid-feedback message">Valid</div>
                							<div class="invalid-feedback message">Name shouldn't be empty</div>
                        				</div>
                        			</div>
                        			<div class="col-md-6">
                        				<div class="row px-3"> 
                							...
                							<input class="mb-4 px-3 form-control" type="password" id="description" name="re-password" placeholder="Re-type password" value='<%=resultSet.getString("password") %>' required> 
                							<div class="valid-feedback message">Valid</div>
                							<div class="invalid-feedback message">Name shouldn't be empty</div>
                        				</div>
                        			</div>

                		...
                		<div class="row mb-4 px-3">
                			<h1 class="mb-5 mr-4 mt-2 left" style="margin-left: -24px;">Coupon Management</h1>
								<div class="row mb-3 px-3"> 
                    				<button type="button" class="btn btn-blue text-center" onClick="location.href ='/gadgetBadget/CouponManagement/coupon-add.jsp'">Add Coupon</button> 
                    			</div>
<%
								//Delete item----------------------------------
								if (request.getParameter("couponID") != null)
								{
									CouponDAO Obj2 = new CouponDAO();
									Obj2.deleteCoupon(request.getParameter("couponID"));
								}
%>
<%                 				CouponDAO Obj1 = new CouponDAO();

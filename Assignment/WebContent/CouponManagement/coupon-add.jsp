<%@ page import="couponManagementService.CouponDAO" language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<!doctype html>
<html>
   <head>
            	...
            	<div class="col-lg-10">
                	<div class="card2 card border-0 px-4 py-5">
                		<div class="row mb-4 px-3">
                			<h1 class="mb-5 mr-4 mt-2 left" style="margin-left: -24px;">Add New Coupon</h1>
								...
								<form class="row g-3 needs-validation" action="<%= request.getContextPath() %>/addCoupon" method="post" novalidate >
									<div class="col-md-12">
											<div class="row px-3"> 
                							<label class="mb-1 ">
									...
									<div class="col-md-6">
                							...
                							<input class="mb-4 px-3 form-control" type="text" id="price" name="expireDate" placeholder="Enter a expire date"  required> 
                							<div class="valid-feedback message">Valid</div>
                							<div class="invalid-feedback message">Name shouldn't be empty</div>
                        				</div>
                					</div>
                        			<div class="col-md-6">	
                        				<div class="row px-3"> 
                							...
                							<input class="mb-4 px-3 form-control" type="text" id="category" name="saving" placeholder="Enter the saving"  required> 
                							<div class="valid-feedback message">Valid</div>
                							<div class="invalid-feedback message">Name shouldn't be empty</div>
                        				</div>
                        			</div>
